           ...
           ?>
            <tr>
                ...
                <td>
                    ...
                    <div class="tombol-opsi-container"><a href="proses/#?&id=<?php echo $r_tampil_transaksi['IdTransaksi'];?>&IdBarang=<?php echo $r_tampil_transaksi['IdBarang']; ?>&TglKembali=<?php echo $r_tampil_transaksi['TglKembali']; ?>
                    &BrgNama=<?php echo $r_tampil_transaksi['BrgNama']; ?>&SwKelas=<?php echo $r_tampil_transaksi['SwKelas']; ?>" onclick = "return confirm ('Apakah Anda Yakin ingin mengembalikan Barang ini ?')" class="tombol">Kembalikan</a></div>
